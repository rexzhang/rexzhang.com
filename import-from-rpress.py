...
def create_restructuredtext_file(post):
    ...
    if category:
        meta = f"{meta}:category: {category}\n"
    if tags:
        meta = f"{meta}:tags: {tags}\n"
    ...
    path = Path(f"content/{content_type}")
...
if __name__ == "__main__":
    import_from_rpress(
        "/Users/rex/Documents/TEMP/blog/rexzhang.com.2020-03-28.06-36-10.801917.rpress.json"
    )
